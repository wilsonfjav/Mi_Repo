...
namespace MovimientoEstudiantil.Migrations
{
    ...
    public partial class MigracionPrincipal : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Estudiante",
                columns: new[] { "id_estudiante", "ProvinciaidProvincia", "SedeidSede", "anioIngreso", "correo", "provincia_id", "satisfaccion_carrera", "sede_id" },
                values: new object[] { 1, null, null, 2023, "gustavo@ucr.ac.cr", 1, "Si", 1 });
